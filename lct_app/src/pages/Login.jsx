    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-500 to-purple-600 text-white px-4">
      ...
      <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 max-w-md w-full">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-white text-gray-800 rounded-xl shadow-lg hover:bg-gray-50 transition-all duration-200 font-medium"
        >
      ...
      <div className="mt-8 text-center max-w-md">
        <p className="text-white/60 text-sm">
          By signing in, you&apos;ll be able to save and manage your conversations, 
          and access all features of Live Conversational Threads.
        </p>
      </div>
    </div>
  );
